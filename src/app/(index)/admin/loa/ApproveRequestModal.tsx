...
export const ApproveRequestModal: React.FC<AcceptRequestModalProps> = ({ request, show, close }) => {
    ...
    return (
        <Modal show={show} title="Approve LOA Request" close={close}>
            <p className="mb-5">
                Are you sure you would like to approve {request.user.first_name} {request.user.last_name}'s LOA request?
            </p>
